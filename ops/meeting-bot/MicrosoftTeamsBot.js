...
exports.MicrosoftTeamsBot = void 0;
...
const ffmpegRecorder_1 = require("../lib/ffmpegRecorder");
...
class MicrosoftTeamsBot extends MeetBotBase_1.MeetBotBase {
    ...
    async join({ url, name, bearerToken, teamId, timezone, userId, eventId, botId, uploader }) {
        ...
        try {
            ...
            if (_state.includes('finished') && !uploadResult) {
                ...
                await (0, botService_1.patchBotStatus)({ botId, eventId, provider: 'microsoft', status: _state, token: bearerToken }, this._logger);
            ...
            if (error instanceof error_1.WaitingAtLobbyRetryError)
                await (0, MeetBotBase_1.handleWaitingAtLobbyError)({ token: bearerToken, botId, eventId, provider: 'microsoft', error }, this._logger);
            throw error;
        }
    }
    async joinMeeting({ url, name, bearerToken, teamId, userId, eventId, botId, pushState, uploader }) {
        ...
        try {
            const warmupPage = await (0, chromium_1.default)(url, this._correlationId, 'microsoft');
        ...
        this.page = await (0, chromium_1.default)(url, this._correlationId, 'microsoft');
        ...
        await (0, resilience_1.retryActionWithWait)('Clicking the join button', async () => {
    ...
    async recordMeetingPageWithFFmpeg({ teamId, userId, eventId, botId, uploader }) {
        ...
        const recorder = new ffmpegRecorder_1.FFmpegRecorder(outputPath, this._logger);
        // Track FFmpeg status
        ...
        try {
            ...
            const inactivityLimitMs = config_1.default.inactivityLimit * 60 * 1000;
                ...
                try {
                    ...
                    const checkInterval = setInterval(async () => {
                        try {
                            ...
                            const { stdout } = await execAsync('timeout 1 parec --device=virtual_output.monitor --format=s16le --rate=16000 --channels=1 2>/dev/null | ' +
            ...
            setTimeout(() => {
                monitorAudioSilence();
            }, config_1.default.activateInactivityDetectionAfter * 60 * 1000);
            // Inject inactivity detection script
            await this.page.evaluate(({ activateAfterMinutes, maxDuration }) => {
                ...
                activateAfterMinutes: config_1.default.activateInactivityDetectionAfter,
...
exports.MicrosoftTeamsBot = MicrosoftTeamsBot;
//# sourceMappingURL=MicrosoftTeamsBot.js.map
