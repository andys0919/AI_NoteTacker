# internal-service-security Specification

## Purpose
Define the trust boundary and authentication expectations for internal worker and webhook routes that mutate job state.
## Requirements
