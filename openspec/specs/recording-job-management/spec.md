# recording-job-management Specification

## Purpose
Define how recording, transcription, and summary stages contribute to lifecycle state, completion semantics, and admission-control behavior for jobs.
## Requirements
