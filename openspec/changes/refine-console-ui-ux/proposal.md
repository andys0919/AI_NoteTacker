...
## What Changes
- Adopt a light, content-first workspace with neutral surfaces and a restrained purple accent across the operator and admin pages.
...
- Affected code: `apps/control-plane/public/` console HTML/CSS/JavaScript, the lightweight operator list serializer, and focused API/shell/UX tests
