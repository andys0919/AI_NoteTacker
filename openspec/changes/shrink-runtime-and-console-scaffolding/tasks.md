...
- [x] 1.2 Create GitHub issue `andys0919/AI_NoteTacker#7` for this exact follow-up scope and link it from the proposal.

## 2. Runtime images
- [x] 2.1 Add explicit transcription and summary targets to the existing Python worker Dockerfile and select them in Compose.
...
- [x] 4.1 Run affected console/catalog tests, syntax checks, Node/Python builds, runtime-probe argument checks, and static dead-reference checks.
- [x] 4.2 Render canonical Compose variants and build/assert final service images and stage-exclusive dependencies.
